...
public class CSPlace extends Place 
{
...
private static final long serialVersionUID = -7943816525234309314L;
        ...
        //TODO: weed out unneeded instance vars,generate setter and getter methods
    ...
    public void setListingId(String listingId) {
            this.setNativeId(listingId);
    }

    public String getWhereId() {
            return this.getWhereId();
    }

    public void setWhereId(String whereId) {
            this.setWhereId(whereId);
    }
    ...
    @Override
    public int hashCode() {
            return this.getNativeId().hashCode();
    }
    
    @Override
    public boolean equals(Object obj) {
            if(obj == null || !(obj instanceof CSPlace)) return false;
            
            return this.getNativeId().equals(((CSPlace)obj).getNativeId());
    }
    
    public JSONObject toJSONSnippet() {
            String listingId = this.getNativeId();
            String whereId = this.getWhereId();
