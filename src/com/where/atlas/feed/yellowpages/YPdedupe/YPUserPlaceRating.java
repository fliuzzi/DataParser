 ...
 * @author fliuzzi
 *
 *	YPUserPlaceRating.java
 *		 Usage: takes in a de-duped YP listings file (generated by YPDeDupe), 
 ...
 *								(it adds one million after finding the max to be SURE)
 *
 */

public class YPUserPlaceRating {
	...
	public YPUserPlaceRating(BufferedReader mergerbr, BufferedReader br,BufferedWriter writer) throws IOException
	{
		count=0;
		this.reader = br;
		this.writer = writer;
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		if(args.length != 3)
		{
			System.err.println("Usage: takes in a de-duped YP listings file (generated by YPDeDupe), and old merger file " +
					"and outputs the merger file");
			System.err.println("arg0:old merger file \t arg1: Deduped file \t arg2: output file");
			return;
		}
		
		
		YPUserPlaceRating main = new YPUserPlaceRating(new BufferedReader(new FileReader(args[0])),
		...
		System.out.println("Done. Wrote "+main.getCount()+" ratings amongst "+main.getUserCount()+" unique YellowPages users.");
