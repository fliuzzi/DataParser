...
public class LocalezeUtil {
	...
	public static CSJSONPlace generateListing(Document ltDoc) {
		return generateListing(ltDoc, -1);
	}
	
	public static CSJSONPlace generateListing(Document ltDoc, double distance) {
		if(ltDoc == null) return null;
		CSJSONPlace LEListing = new CSJSONPlace();
