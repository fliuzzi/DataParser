...
public class CSListing implements Serializable {
	...
	public boolean equalsTo(Object obj) {
		...
		return ((listingId != null && listingId.equalsIgnoreCase(objCSListing.listingId) || (listingId == null && objCSListing.listingId == null)) &&
				((whereId != null && whereId.equalsIgnoreCase(objCSListing.whereId) || (whereId == null && objCSListing.whereId == null))));
	}
	...
	public JSONObject toJSONSnippet() {
		try {
			...
			if(because != null && !because.isEmpty()) {
				CSListing b = because.size() > 1 ? because.get((new Random()).nextInt(because.size())) : because.get(0);
