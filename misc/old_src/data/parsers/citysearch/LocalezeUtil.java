...
public class LocalezeUtil {
	...
	public static CSListing generateListing(Document ltDoc) {
		return generateListing(ltDoc, -1);
	}
	
	public static CSListing generateListing(Document ltDoc, double distance) {
		if(ltDoc == null) return null;
		CSListing LEListing = new CSListing();
        LEListing.setSource(sourceEnum.Localeze);
